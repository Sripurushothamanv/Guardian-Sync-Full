    ...
    <div className="burnout-wrapper">
      ...
      <div className="screen-content-split">
        ...
        <div className="chart-side glass-panel">
          ...
          <div className="burnout-chart-box">
            <svg viewBox={`0 0 ${chartWidth} ${chartHeight}`} className="svg-chart">
              ...
              {fatigueTrend.map((item, idx) => {
                ...
                const h = (item.score / 100) * (chartHeight - padding * 2);
                const y = chartHeight - padding - h;
                const isOverThreshold = item.score >= 70;
                ...
                return (
                  <g key={idx}>
                    ...
                    />
                    <text x={x + barWidth/2} y={chartHeight - 4} fontSize="8" fill="var(--text-secondary)" textAnchor="middle">
                      {item.day}
                    </text>
