    ...
    <div className="dashboard-wrapper">
      ...
      <section className="metrics-grid">
        ...
        <div className="metric-card glass-panel">
          ...
          <div className="metric-footer" style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.4rem', marginTop: '0.2rem' }}>
              <button 
                ...
                onClick={() => addLog('nutrition', { foodItem: 'Water (250ml)', volume: 250, calories: 0, timestamp: new Date() })}
              >
                + 250ml
              </button>
              <button 
                className="btn-secondary btn-small" 
                style={{ padding: '0.25rem 0.5rem', fontSize: '0.72rem', borderRadius: '4px' }}
                onClick={() => addLog('nutrition', { foodItem: 'Water (500ml)', volume: 500, calories: 0, timestamp: new Date() })}
              >
                + 500ml
              </button>
            </div>
